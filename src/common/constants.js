(function registerMAOEConstants(globalScope) {
  ...
  const MESSAGING = {
    ...
    TYPES: {
      ...
      POPUP_SAVE_REPOSITORY_SETTINGS: 'POPUP/SAVE_REPOSITORY_SETTINGS',
      POPUP_SAVE_AGENT_SETTINGS: 'POPUP/SAVE_AGENT_SETTINGS',
      POPUP_VALIDATE_GITHUB_TOKEN: 'POPUP/VALIDATE_GITHUB_TOKEN',
